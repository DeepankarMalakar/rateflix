...
<div class="container" style="max-width: 720px;">
    ...
    <div class="form-card">
        <form method="POST" action="{{ url('/admin/movies/store') }}" novalidate>
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="url" id="poster_url" name="poster_url" class="form-control" value="{{ old('poster_url') }}" placeholder="Leave blank to auto-fetch from TMDB">
            </div>
